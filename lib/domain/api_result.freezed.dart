...
class _$ApiResultTearOff {
  ...
  Success<T> success<T>({required List<UsersModel> data}) {
    return Success<T>(
      data: data,
    );
  }
...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(List<UsersModel> data) success,
    required TResult Function(NetworkExceptions error) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(List<UsersModel> data)? success,
...
abstract class Success<T> implements ApiResult<T> {
  const factory Success({required List<UsersModel> data}) = _$Success<T>;
